...
* Descripción
 ...
 Es un programa para calcular la duración de un juego con dos horas como entrada.
...
* Funcionamiento 
Se construyó un lector BufferedReader de la clase homónima para tratar los datos con el formato de entrada de Beecrowd; también se implementó un bucle while que corre el programa siempre y cuando haya una línea nueva en la entrada
